...
msg_no_spaces = strrep(msg, ' ', ''); % αφαίρεση των κενών από το μήνυμα (δεν είναι γράμμα)
binstream = huffmanenco(msg_no_spaces, dict);
...
%! σε αγγλικά κείμενα όπως παρουσιάζονται στο παραπάνω 
%! γράφημα
...
% Ουσιαστικά η κωδικοποιήση Huffman αντιστοιχεί σύμβολα με κωδικολέξεις με βάση την πιθανότητα εμφάνισης τους
% στο κειμενό μας. Η αντιστοίχιση δηλαδή των κωδικων λέξεων είναι σύμφωνα με ποιο σύμβολο εμφανίζεται λιγότερο.
% Π.χ το e που ειναι το πιο σύχνό γράμμα αντιστοιχεί στην κωδική λέξη με το λιγότερο μήκος απο bit. Αντίστοιχα, 
% ο κώδικας Morse δημιουργήθηκε για επικοινωνία με ηλεκτρικό τηλεγράφο και για να είναι πιο γρήγορη λοιπόν αυτη η
% επικοινωνία τα πιο συχνά γράμματα λάμβαναν το σύντομο '.', όπως το e που είναι το πιο συχνό γράμμα στην αγγλική γλώσσα.
% Ενώ άλλα πιο σπάνια το '-' που έχει μεγαλύτερη διάρκεια. Σε εμάς δηλαδή το 0 θα μπορούσε να αντιστοιχεί στο '.' και
% το 1 στο '-' του Morse.